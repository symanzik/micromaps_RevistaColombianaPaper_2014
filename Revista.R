### R Code for Revista Columbiana Article
###
...
###   Part 7: Linked Mircomap Plots for Argentina (Figure 3)
...
setwd("C://JUE//Revista_Columbiana//RFiles")
...
as.SpatialPolygons.bbox <- function(x) {
  ...
  bboxMat <- rbind(c(bbox(x)["x", "min"], bbox(x)["y", "min"]), 
...
ArgShapefile <- readShapeSpatial("Shapefiles/ARG_adm/ARG_adm1", 
                                 verbose = TRUE)
plot(ArgShapefile)
ArgShapefileThin <- thinnedSpatialPoly(ArgShapefile, tolerance = 0.05,
...
BolShapefile <- readShapeSpatial("Shapefiles/BOL_adm/BOL_adm1", 
                                 verbose = TRUE)
plot(BolShapefile)
BolShapefileThin <- thinnedSpatialPoly(BolShapefile, tolerance = 0.05,
                                       topologyPreserve = TRUE, avoidGEOS = FALSE)
...
BraShapefile <- readShapeSpatial("Shapefiles/BRA_adm/BRA_adm1", 
                                 verbose = TRUE)
plot(BraShapefile)
BraShapefileThin <- thinnedSpatialPoly(BraShapefile, tolerance = 0.05,
                                       topologyPreserve = TRUE, avoidGEOS = FALSE)
...
ChiShapefile <- readShapeSpatial("Shapefiles/CHL_adm/CHL_adm1", 
                                 verbose = TRUE)
plot(ChiShapefile)
ChiShapefileThin <- thinnedSpatialPoly(ChiShapefile, tolerance = 0.05,
                                       topologyPreserve = TRUE, avoidGEOS = FALSE)
...
ColShapefile = readShapeSpatial("Shapefiles/COL_adm/COL_adm1", 
                                verbose = TRUE)
plot(ColShapefile)
ColShapefileThin <- thinnedSpatialPoly(ColShapefile, tolerance = 0.05,
                                       topologyPreserve = TRUE, avoidGEOS = FALSE)
...
EcuShapefile <- readShapeSpatial("Shapefiles/ECU_adm/ECU_adm1", 
                                 verbose = TRUE)
plot(EcuShapefile)
EcuShapefileThin <- thinnedSpatialPoly(EcuShapefile, tolerance = 0.05,
                                       topologyPreserve = TRUE, avoidGEOS = FALSE)
...
GuyShapefile <- readShapeSpatial("Shapefiles/GUY_adm/GUY_adm1", 
                                 verbose = TRUE)
plot(GuyShapefile)
GuyShapefileThin <- thinnedSpatialPoly(GuyShapefile, tolerance = 0.05,
                                       topologyPreserve = TRUE, avoidGEOS = FALSE)
...
PerShapefile <- readShapeSpatial("Shapefiles/PER_adm/PER_adm1", 
                                 verbose = TRUE)
plot(PerShapefile)
PerShapefileThin <- thinnedSpatialPoly(PerShapefile, tolerance = 0.05,
                                       topologyPreserve = TRUE, avoidGEOS = FALSE)
...
PryShapefile <- readShapeSpatial("Shapefiles/PRY_adm/PRY_adm1", 
                                 verbose = TRUE)
plot(PryShapefile)
PryShapefileThin <- thinnedSpatialPoly(PryShapefile, tolerance = 0.05,
                                       topologyPreserve = TRUE, avoidGEOS = FALSE)
...
SurShapefile <- readShapeSpatial("Shapefiles/SUR_adm/SUR_adm1", 
                                 verbose = TRUE)
plot(SurShapefile)
SurShapefileThin <- thinnedSpatialPoly(SurShapefile, tolerance = 0.05,
                                       topologyPreserve = TRUE, avoidGEOS = FALSE)
...
UryShapefile <- readShapeSpatial("Shapefiles/URY_adm/URY_adm1", 
                                 verbose = TRUE)
plot(UryShapefile)
UryShapefileThin <- thinnedSpatialPoly(UryShapefile, tolerance = 0.05,
                                       topologyPreserve = TRUE, avoidGEOS = FALSE)
...
VenShapefile <- readShapeSpatial("Shapefiles/VEN_adm/VEN_adm1", 
                                 verbose = TRUE)
plot(VenShapefile)
VenShapefileThin <- thinnedSpatialPoly(VenShapefile, tolerance = 0.05,
                                       topologyPreserve = TRUE, avoidGEOS = FALSE)
...
postscript("SA_Countries_05_26_2014.ps", paper = "special",
...
postscript("Brazil_Boundaries_05_26_2014.ps", paper = "special",
...
Bratable <- data.frame(Bratable[, 1:4], sapply(Bratable[, 5:13], function(x) as.numeric(as.character(x))))
...
mmplot(stat.data = Bratable,
       map.data = BrazilPolys,
       panel.types = c("map", "dot_legend", "labels", 
                       "dot", "dot", "dot"),
       panel.data = list(NA, "points", "StateMod", 
       ...
       colors = Greys5,
       map.color2 = gray(0.9),
       panel.att = list(list(1, header = "Maps",
                             panel.width = 0.6,
                        ...
                        list(6, header = "Infant Mortality\nin 2014", 
                             point.type = 20,
                             point.size = 1.4,
                             graph.bgcolor = gray(0.9),
       ...
       print.file = "BRA_1_1_05_26_2014_not_used.ps",
       print.res = 300
)
...
mmplot(stat.data = Bratable,
       map.data = BrazilPolys,
       panel.types = c("dot_legend", "labels", "dot", 
                       "dot", "dot", "map"),
       panel.data = list("points", "StateMod", 
                         "Population..2014.", "GDP.per.capita..R....2014.", 
       ...
       colors = Greys5,
       map.color2 = gray(0.9),
       panel.att = list(list(6, header = "Maps", 
                             panel.width = 0.6,
                             active.border.color = "black",
                             active.border.size = 0.5,
                             inactive.border.color = gray(0.7), 
                        ...
                        list(4, header = "GDP per Capita\nin 2014", 
                             ...
                             xaxis.labels = list(0, 25000, 50000),
                             xaxis.title = "Brazillian Real ($)"),
                        list(5, header = "Infant Mortality\nin 2014", 
                             point.type = 20,
                             point.size = 1.4,
                             graph.bgcolor = gray(0.9),
                             xaxis.ticks = list(0, 10, 20), 
                             xaxis.labels = list(0, 10, 20),
                             xaxis.title = "Per thousand (per mille)")),
       print.file = "BRA_1_2_05_26_2014.ps",
       print.res = 300
)
...
myTable <- create_DF_rank(Bratable2, ord.by = "2008", 
...
mmplot(stat.data = Bratable2,
       ...
       colors = Greys5,
       map.color2 = gray(0.9),
       panel.att = list(list(1, header = "Maps", panel.width = 0.8,
                             active.border.color = "black",
                             active.border.size = 0.5,
                             inactive.border.color = gray(0.7), 
                             inactive.border.size = 0.5),
                        ...
                        list(4, header = "Murder Rate\nin 1998", 
                             ...
                             xaxis.title = "Percent (%)",
                             panel.width = 1.8),
                        list(5, header = "Murder Rate Change\nfrom 1998 to 2008",
                             graph.bgcolor = gray(0.9),
                             xaxis.title = "Percentage Points",
                             panel.width = 1.8)),
       print.file = "BRA_2_05_26_2014.ps",
       print.res = 300
)
...
names(ArgShapefile)
ArgShapefile$NAME_1
ArgShapefileThin <- thinnedSpatialPoly(ArgShapefile, tolerance = 0.1,
                                       topologyPreserve = TRUE, avoidGEOS = FALSE)
...
myTable <- create_DF_rank(Argtable, ord.by = "2010 Population", 
...
myPanel <- ggplot(myTable) +
  geom_segment(aes(x = 0, y = -pGrpOrd, xend = data1, yend = -pGrpOrd, 
                   colour = factor(color))) +
  facet_grid(pGrp ~ .) +
...
bar_plot_build <- function(myPanel, myNumber, myNewStats, myAtts) {
  ...
  myPanel <- ggplot(myTable) +
    geom_segment(aes(x = 0, y = -pGrpOrd,
...
mmplot(stat.data = Argtable,
       ...
       panel.att = list(list(1, header = "Maps",
                             ...
                             inactive.border.color = gray(0.7), 
                             inactive.border.size = 0.5),
                        list(2, header = "Provinces",
                             align = "center",
                             text.size = 0.9,
                             panel.width = 1.5),
                        list(3, header = "2010 Population", 
                             graph.bgcolor = gray(0.95),
                             xaxis.ticks = list(0, 5, 10, 15, 20), 
                             xaxis.labels = list(0, 5, 10, 15, 20),
                             xaxis.title = "People (Millions)",
                             panel.width = 1.6),
                        list(4, header = "Population Increase\nfrom 2001 to 2010", 
                             graph.bgcolor = gray(0.95),
                             xaxis.title = "People (Millions)",
                             panel.width = 1.6)),
       print.file = "ARG_1_1_05_26_2014_not_used.ps",
       print.res = 300
)
...
mmplot(stat.data = Argtable,
       ...
       panel.types = c("map", "dot_legend", "labels", 
                       "dot", "bar_plot", "dot"),
       panel.data = list(NA, "points", "ProvinceTemp", 
...
names(UruShapefile)
UruShapefile$NAME_1
UruShapefileThin <- thinnedSpatialPoly(UruShapefile, tolerance = 0.01,
                                       topologyPreserve = TRUE, avoidGEOS = FALSE)
...
mmplot(stat.data = Urutable,
       ...
       colors = Greys6,
       map.color2 = gray(0.95),
       panel.att = list(list(5, header = "Maps",
                             active.border.color = "black",
                             active.border.size = 0.5,
                             inactive.border.color = gray(0.7), 
                             inactive.border.size = 0.5,
